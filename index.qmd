...
![Schätzer des Schätzers der Standardabweichung [@Steyer_2013]](SchaetzSD.PNG){left=0 width=70%}
...
![Reben mit Gerüst](reben.png){left=0 width=70%}
...
![Fragebogen-Software](BeispielQN.PNG){left=0 width=80%}



## Beispiel 2: Daten auswerten 

![Foliensatz auf dem [ZOERR](http://hdl.handle.net/10900.3/OER_UWBKNJRO)](Beisipiel_Software.png){left=0 width=80%}
...
* [Wie setze ich in verschiedenen Lehr-Kontexten Werkzeuge gezielt ein?]{.imp}
* [Welche weiteren Möglichkeiten gibt es, Lernende durch informationsverarbeitende Technologien zu unterstützen?]{.imp}
* [Können Methoden auf andere Lehr-Lern-Prozesse übertragen werden?]{.imp}
:::


::: notes
* authentische Lernprozesse
