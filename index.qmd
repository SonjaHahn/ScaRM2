...
- Within-person randomisiert dargestellt in allen verwendeten Grafiktypen *(stacked, clustered and facetted bar graphs, jitter graphs mit means, beeswarm graphs)*
...
<center>
![Abbildung aus [@merk2023a]](img/Figure_6.svg){width=46%}
</center>


## Studie 1: Ergebnisse - Effektivität
<center>
![Abbildung aus [@merk2023a]](img/Figure_3.png){width=75%}
</center>

## Studie 1: Ergebnisse - Akkuratheit 
<center>
![Abbildung aus [@merk2023a]](img/Figure_8.svg){width=90%}
</center>

## Studie 1: Schlussfolgerung - Limitationen {.smaller .center}
* Schlussfolgerung:
...
![](img/mindsteps_auswahl_testart.png){.fragment width="850"}

![](img/mindsteps_ergebnisse_klasse_querschnitt.png){.fragment width="780"}

![](img/mindsteps_ergebnisse_einzelschuelerin.png){.fragment width="590"}
:::
...
visNetwork(nodes, edges, width = "1028px", height = "407px",
           ...
           main = list(text = "Custom title",
                          style = "font-family:Roboto;color:#141414;font-size:1px;text-align:left;") ) %>%
...
* Schlussfolgerungen
   * Hypothese: Fehleranalyse stellt zentrale Heuristik des Sensemaking dar
...
## <!--Meme-->{background-image="img/meme.png" background-size="contain"}
